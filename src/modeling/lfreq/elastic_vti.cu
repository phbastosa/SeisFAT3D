...
void Elastic_VTI::forward_solver()
{
    ...
    {
        compute_pressure<<<nBlocks, nThreads>>>(d_Vx, d_Vy, d_Vz, d_Txx, d_Tyy, d_Tzz, d_Txz, d_Tyz, d_Txy, d_P, d_C11, d_C33, d_C55, d_C66, d_C13, wavelet, sIdx, sIdy, sIdz, tId, nt, dx, dy, dz, dt, nxx, nyy, nzz);
