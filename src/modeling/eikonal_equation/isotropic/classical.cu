...
void Classical::set_volumes()
{
    type_name = std::string("pod");
    type_message = std::string("[0] - Podvin & Lecomte (1991)");
...
void Classical::initialization()
{
    ...
    K[source_index - 1] = 1.0f;
    K[source_index + 1] = 1.0f;
    K[source_index - nzz] = 1.0f;
    K[source_index + nzz] = 1.0f;
    K[source_index - nxx*nzz] = 1.0f;
    K[source_index + nxx*nzz] = 1.0f;
    K[source_index + 1 - nzz] = 1.0f;
    K[source_index - 1 - nzz] = 1.0f;
    K[source_index + 1 + nzz] = 1.0f;
    K[source_index - 1 + nzz] = 1.0f;
    K[source_index + 1 + nxx*nzz] = 1.0f;
    K[source_index + 1 - nxx*nzz] = 1.0f;
    K[source_index - 1 + nxx*nzz] = 1.0f;
    K[source_index - 1 - nxx*nzz] = 1.0f;
    K[source_index - nzz - nxx*nzz] = 1.0f;
    K[source_index - nzz + nxx*nzz] = 1.0f;
    K[source_index + nzz - nxx*nzz] = 1.0f;
    K[source_index + nzz + nxx*nzz] = 1.0f;
    K[source_index + 1 + nzz + nxx*nzz] = 1.0f;
    K[source_index + 1 + nzz - nxx*nzz] = 1.0f;
    K[source_index + 1 - nzz + nxx*nzz] = 1.0f;
    K[source_index + 1 - nzz - nxx*nzz] = 1.0f;
    K[source_index - 1 - nzz - nxx*nzz] = 1.0f;
...
void Classical::set_forward_solver()
{
