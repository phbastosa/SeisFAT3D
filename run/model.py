...
dobs = np.fromfile("../inputs/data/fsm_data_22500_shot_221.bin", count=n, dtype = np.float32)
dcal = np.fromfile("../outputs/seismograms/fsm_data_22500_shot_221.bin", count=n, dtype = np.float32)
