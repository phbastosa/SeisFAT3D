...
vp.flatten("F").astype(np.float32, order = "F").tofile(f"../inputs/models/anisoTomo_bg.bin")
...
vp.flatten("F").astype(np.float32, order = "F").tofile("../inputs/models/anisoTomo_vp.bin")
