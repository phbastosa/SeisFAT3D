...
Tx = np.zeros((nz, nx, ny))
Ty = np.zeros((nz, nx, ny))
Tz = np.zeros((nz, nx, ny))
...
vp.flatten("F").astype(np.float32, order = "F").tofile(f"../inputs/models/inversion_test_bg.bin")
...
dD3 = np.array([ 0,  0,  0,  0])

dG1 = np.array([ 0,  0,  0,  0])
dG2 = np.array([ 0,  0,  0,  0])
...
for k in range(len(circle_centers)):
    ...
    Tx[distance <= radius] += dTx[k]
    Ty[distance <= radius] += dTy[k]
    Tz[distance <= radius] += dTz[k]
...
for circles in points:
    ...
    for index in range(len(ip)):
        ...
        C[2,0] = C13[i,j,k]; C[2,1] = C12[i,j,k]; C[2,2] = C33[i,j,k]; C[2,3] = C34[i,j,k]; C[2,4] = C35[i,j,k]; C[2,5] = C36[i,j,k]  
        ...
        c = np.cos(Tx[i,j,k]); s = np.sin(Tx[i,j,k])
        Rx = np.array([[1, 0, 0],[0, c,-s],[0, s, c]])

        c = np.cos(Ty[i,j,k]); s = np.sin(Ty[i,j,k])
        Ry = np.array([[c, 0, s],[0, 1, 0],[-s, 0, c]])

        c = np.cos(Tz[i,j,k]); s = np.sin(Tz[i,j,k])
...
vp.flatten("F").astype(np.float32, order = "F").tofile("../inputs/models/inversion_test_vp.bin")

C11.flatten("F").astype(np.float32, order = "F").tofile("../inputs/models/inversion_test_C11.bin")
C12.flatten("F").astype(np.float32, order = "F").tofile("../inputs/models/inversion_test_C12.bin")
C13.flatten("F").astype(np.float32, order = "F").tofile("../inputs/models/inversion_test_C13.bin")
C14.flatten("F").astype(np.float32, order = "F").tofile("../inputs/models/inversion_test_C14.bin")
C15.flatten("F").astype(np.float32, order = "F").tofile("../inputs/models/inversion_test_C15.bin")
C16.flatten("F").astype(np.float32, order = "F").tofile("../inputs/models/inversion_test_C16.bin")

C22.flatten("F").astype(np.float32, order = "F").tofile("../inputs/models/inversion_test_C22.bin")
C23.flatten("F").astype(np.float32, order = "F").tofile("../inputs/models/inversion_test_C23.bin")
C24.flatten("F").astype(np.float32, order = "F").tofile("../inputs/models/inversion_test_C24.bin")
C25.flatten("F").astype(np.float32, order = "F").tofile("../inputs/models/inversion_test_C25.bin")
C26.flatten("F").astype(np.float32, order = "F").tofile("../inputs/models/inversion_test_C26.bin")

C33.flatten("F").astype(np.float32, order = "F").tofile("../inputs/models/inversion_test_C33.bin")
C34.flatten("F").astype(np.float32, order = "F").tofile("../inputs/models/inversion_test_C34.bin")
C35.flatten("F").astype(np.float32, order = "F").tofile("../inputs/models/inversion_test_C35.bin")
C36.flatten("F").astype(np.float32, order = "F").tofile("../inputs/models/inversion_test_C36.bin")

C44.flatten("F").astype(np.float32, order = "F").tofile("../inputs/models/inversion_test_C44.bin")
C45.flatten("F").astype(np.float32, order = "F").tofile("../inputs/models/inversion_test_C45.bin")
C46.flatten("F").astype(np.float32, order = "F").tofile("../inputs/models/inversion_test_C46.bin")

C55.flatten("F").astype(np.float32, order = "F").tofile("../inputs/models/inversion_test_C55.bin")
C56.flatten("F").astype(np.float32, order = "F").tofile("../inputs/models/inversion_test_C56.bin")

C66.flatten("F").astype(np.float32, order = "F").tofile("../inputs/models/inversion_test_C66.bin")
