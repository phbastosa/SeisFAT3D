...
theta_x = np.array([0.0]) * np.pi/180.0
theta_y = np.array([0.0]) * np.pi/180.0
...
C12.flatten("F").astype(np.float32, order = "F").tofile("../inputs/models/modeling_test_C12.bin")
C13.flatten("F").astype(np.float32, order = "F").tofile("../inputs/models/modeling_test_C13.bin")
C14.flatten("F").astype(np.float32, order = "F").tofile("../inputs/models/modeling_test_C14.bin")
C15.flatten("F").astype(np.float32, order = "F").tofile("../inputs/models/modeling_test_C15.bin")
C16.flatten("F").astype(np.float32, order = "F").tofile("../inputs/models/modeling_test_C16.bin")

C22.flatten("F").astype(np.float32, order = "F").tofile("../inputs/models/modeling_test_C22.bin")
C23.flatten("F").astype(np.float32, order = "F").tofile("../inputs/models/modeling_test_C23.bin")
C24.flatten("F").astype(np.float32, order = "F").tofile("../inputs/models/modeling_test_C24.bin")
C25.flatten("F").astype(np.float32, order = "F").tofile("../inputs/models/modeling_test_C25.bin")
C26.flatten("F").astype(np.float32, order = "F").tofile("../inputs/models/modeling_test_C26.bin")

C33.flatten("F").astype(np.float32, order = "F").tofile("../inputs/models/modeling_test_C33.bin")
C34.flatten("F").astype(np.float32, order = "F").tofile("../inputs/models/modeling_test_C34.bin")
C35.flatten("F").astype(np.float32, order = "F").tofile("../inputs/models/modeling_test_C35.bin")
C36.flatten("F").astype(np.float32, order = "F").tofile("../inputs/models/modeling_test_C36.bin")

C44.flatten("F").astype(np.float32, order = "F").tofile("../inputs/models/modeling_test_C44.bin")
C45.flatten("F").astype(np.float32, order = "F").tofile("../inputs/models/modeling_test_C45.bin")
C46.flatten("F").astype(np.float32, order = "F").tofile("../inputs/models/modeling_test_C46.bin")

C55.flatten("F").astype(np.float32, order = "F").tofile("../inputs/models/modeling_test_C55.bin")
C56.flatten("F").astype(np.float32, order = "F").tofile("../inputs/models/modeling_test_C56.bin")

C66.flatten("F").astype(np.float32, order = "F").tofile("../inputs/models/modeling_test_C66.bin")
